  ...
  <div id="app">
    <div class="ui inverted vertical masthead center aligned segment">
      <div class="ui text container">
        ...
        <h2 class="ui inverted header">Fernando "ferox" dos Santos
          <div class="sub header">Especialista em Tecnologia Open Source</div>
        </h2>
        <h3 class="ui inverted header">Rio de Janeiro, Brasil - 2020</h3>
        <a class="tiny ui linkedin button" type="button" href="https://www.linkedin.com/in/ferox">
          <i class="linkedin icon"></i>
          LinkedIn
        </a>
        <a class="tiny ui twitter button" type="button" href="https://twitter.com/hacker_ferox">
